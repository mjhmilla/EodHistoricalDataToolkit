...
class ScreenerFunctions {
  ...
  public:
    ...
    struct MetricSummaryDataSet{
      ...
      std::vector < std::vector < DataStructures::SummaryStatistics > > summaryStatistics;
    ...
    static bool appendMetricData(
      ...
      if(rankingFieldExists){
        ...
        std::vector< DataStructures::SummaryStatistics> percentileVector;
        double weight=1.0;
        ...
        for( auto const &rankingItem : screenReportConfig["ranking"].items()){
          ...
          DataStructures::SummaryStatistics percentileSummary;
